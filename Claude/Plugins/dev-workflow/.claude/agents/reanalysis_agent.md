...
1. Read `<codebase_path>/.dev-workflow/codebase_context.md` — this is the snapshot of the codebase structure, tech
   stack, file map, and patterns. Use it to understand the codebase without re-reading files.
